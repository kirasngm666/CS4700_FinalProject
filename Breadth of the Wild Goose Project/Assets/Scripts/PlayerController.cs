...
public class PlayerController : MonoBehaviour
{
    ...
    void PlayerDebugInput()
    {
        ...
        if (Input.GetKeyDown(KeyCode.B))
        {
            ...
            if (bullets.Length > 0)
            {
                ...
                {
                    bullet.GetComponent<BulletScriptTest>().FreezeBullet(freezeBullets);
                }
            }
    ...
    void ShootBullet()
    {
        ...
        bullet.GetComponent<BulletScriptTest>().SetDamageValue(bulletDamage);
        bullet.GetComponent<BulletScriptTest>().SetBulletSpeed(bulletSpeed);
        bullet.GetComponent<BulletScriptTest>().SetBulletDirection((isFacingRight) ? Vector2.right : Vector2.left);
