...
public class ScrewDriverController : MonoBehaviour
{
    ...
    private void ShootBullet()
    {
        ...
        for (int i = 0; i < bullets.Length; i++)
        {
            ...
            bullets[i].GetComponent<BulletScriptTest>().SetBulletType(bulletType);
            bullets[i].GetComponent<BulletScriptTest>().SetDamageValue(enemyController.bulletDamage);
            bullets[i].GetComponent<BulletScriptTest>().SetBulletSpeed(enemyController.bulletSpeed);
            bullets[i].GetComponent<BulletScriptTest>().SetBulletDirection(bulletVectors[i]);
            bullets[i].GetComponent<BulletScriptTest>().SetCollideWithTags("Player");
            bullets[i].GetComponent<BulletScriptTest>().SetDestroyDelay(5f);
            bullets[i].GetComponent<BulletScriptTest>().Shoot();
        }
