...
public class BlasterController : MonoBehaviour
{
    ...
    BulletScriptTest.BulletTypes bulletType;
    ...
    void SetBulletType()
    {
        ...
        {
            case BlasterColors.Blue:
                bulletType = BulletScriptTest.BulletTypes.MiniBlue;
                break;
            case BlasterColors.Orange:
                bulletType = BulletScriptTest.BulletTypes.MiniPink;
                break;
            case BlasterColors.Red:
                bulletType = BulletScriptTest.BulletTypes.MiniRed;
                break;
        }
    }
    ...
    private void ShootBullet()
    {
        ...
        bullet.GetComponent<BulletScriptTest>().SetBulletType(bulletType);
        bullet.GetComponent<BulletScriptTest>().SetDamageValue(enemyController.bulletDamage);
        bullet.GetComponent<BulletScriptTest>().SetBulletSpeed(enemyController.bulletSpeed);
        bullet.GetComponent<BulletScriptTest>().SetBulletDirection(bulletVectors[bulletIndex]);
        bullet.GetComponent<BulletScriptTest>().SetCollideWithTags("Player");
        bullet.GetComponent<BulletScriptTest>().SetDestroyDelay(5f);
        bullet.GetComponent<BulletScriptTest>().Shoot();
